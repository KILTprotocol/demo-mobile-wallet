...
* 📱 in the mobile app = as the **Claimer**
  ...
  * Under `Contacts`: Add a contact by scanning a KILT Public Identity QR Code displayed in the demo-client. A little mailbox icon should be displayed next to their name.
  * Under `Dashboard`: 
